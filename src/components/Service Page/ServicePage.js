            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav ms-auto flex-lg-column text-lg-center">
                    ...
                    <li className="nav-item">
                        <Link to="home" className="nav-link home-nav" >Home</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="about" className="nav-link About-nav" >About</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="services" className="nav-link Services-nav" >Services</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="work" className="nav-link Work-nav" >Work</Link>
                    </li>
                   
                    {/* <li className="nav-item">
                        <Link to="reviews" className="nav-link Reviews-nav" >Reviews</Link>
                    </li> */}
                    {/* <li className="nav-item">
                        <Link to="blog" className="nav-link Blog-nav" >Blog</Link>
                    </li> */}
                    <li className="nav-item">
                        <Link to="contact" className="nav-link Contact-nav" >Contact</Link>
                    </li>
    ...
    <div id="content-wrapper">
                ...
                <div className="row">
                    <div className="col-lg-10">
                        ...
                        <div data-aos="fade-up" data-aos-delay="600">
                            ...
                            <Link to="work" className="btn btn-brand me-3" >Explore My Work</Link>
                            </div>
            ...
            <div className="container">
                ...
                <div className="row pb-4" data-aos="fade-up">
                    <div className="col-lg-8">
                        <h6 className="text-brand heading">ABOUT</h6>
        ...
        <section id="services" className="full-height px-lg-5">
            <div className="container">
                ...
                <div className="row pb-4" data-aos="fade-up">
                    <div className="col-lg-8">
                        <h6 className="text-brand heading">SERVICES</h6>
        ...
        <section id="work" className="full-height px-lg-5">
            <div className="container">
                ...
                <div className="row pb-4" data-aos="fade-up">
                    <div className="col-lg-8">
                        <h6 className="text-brand heading">WORK</h6>
                        ...
                        <div className="work-middle">
                            <div className="card-custom rounded-4 bg-base shadow-effect  work-inner">
                                ...
                                <div className="card-custom-content p-4">
                                    ...
                                    <p>This is the Solid Online Company Website </p>
                                    <Link href="#" className="link-custom">Read More</Link>
                                </div>
                            </div>
                        </div>
        ...
        <section id="reviews" className="full-height px-lg-5">
            <div className="container">
                ...
                <div className="row pb-4" data-aos="fade-up">
                    <div className="col-lg-8">
                        <h6 className="text-brand heading">REVIEWS</h6>
        ...
        <section id="blog" className="full-height px-lg-5">
            <div className="container">
                ...
                <div className="row pb-4" data-aos="fade-up">
                    <div className="col-lg-8">
                        <h6 className="text-brand heading">BLOG</h6>
            ...
            <div className="container">
                ...
                <div className="row justify-content-center text-center">
                    <div className="col-lg-8 pb-4" data-aos="fade-up">
                        <h6 className="text-brand heading">CONTACT</h6>
                ...
                <div className="row gy-4 justify-content-between">
                    ...
                    <div className="col-auto">
                        <div className="social-icons">
                            <ExternalLink href="https://github.com/SureshKumarMeesala"> <i className="lab la-github"></i></ExternalLink>
                            <ExternalLink href="https://www.linkedin.com/in/suresh-kumar-meesala/"> <i className="lab la-linkedin"></i></ExternalLink>
                        </div>
                    </div>
                </div>
            </div>
